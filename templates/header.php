        ...
        <div class="container px-5">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              // Condition isAdmin
              if (User::isAdmin()) { ?>
                <li class="nav-item"><a class="nav-link" href="index.php?controller=admin&action=dashboard">Dashboard</a></li>
              <?php }

              if (User::isUser()) { ?>
                <li class="nav-item"><a class="nav-link" href="index.php?controller=user&action=profile#mes-infos" title="Infos personnelles">Mes informations</a></li>
              ...
              <?php } else { ?>
                <li class="nav-item"><a class="nav-link" href="index.php?controller=auth&action=login" title="Connexion">Connexion
